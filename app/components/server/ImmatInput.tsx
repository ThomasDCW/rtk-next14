  ...
  return (
    <form className="flex items-center">
      ...
      <input
        ...
        className="placeholder:opacity-50 placeholder:text-center text-center border-t-2 border-b-2 border-[rgb(1,51,153)] h-full
        focus:border-[rgb(1,51,153)] focus:ring-inset focus:ring-[rgb(1,51,153)]"
        onInput={formatImmat}
      />
      <div className="bg-[rgb(1,51,153)] rounded-r-lg w-5 h-full"></div>
